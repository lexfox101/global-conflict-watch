...
export function SiteHeader() {
  return (
    <header className="site-header">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-3 focus:z-50 focus:rounded-full focus:border focus:border-cyan-300/30 focus:bg-[rgb(5_12_21/0.98)] focus:px-4 focus:py-2 focus:text-[13px] focus:text-cyan-100"
      >
        Skip to content
      </a>
