      ...
      <div className="mx-auto w-full max-w-[1400px] px-4 py-10 lg:px-6 lg:py-14">
          ...
          <div>
            ...
            <div className="mt-7 flex flex-wrap items-center gap-3">
              <Link
                ...
                className="rounded-full border border-cyan-300/25 bg-cyan-400/10 px-5 py-2.5 text-[14px] font-semibold text-cyan-100 transition-colors hover:bg-cyan-400/15"
              >
                Read today&apos;s briefing
              </Link>
              <Link
                href="/briefings"
                className="rounded-full border border-white/10 px-5 py-2.5 text-[14px] text-slate-300 transition-colors hover:bg-white/5 hover:text-slate-100"
              >
                Browse the archive
              </Link>
            </div>
        ...
        <section className="mt-14 grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-stretch">
          <article className="soft-panel flex flex-col gap-4 p-6 sm:p-8">
            ...
            <Link
              href={`/briefings/${latestBriefing.slug}`}
              className="self-start rounded-full border border-cyan-300/25 bg-cyan-400/10 px-5 py-2.5 text-[14px] font-semibold text-cyan-100 transition-colors hover:bg-cyan-400/15"
            >
              Read full briefing
            </Link>
          </article>
